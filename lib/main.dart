...
void main() async {
  ...
  SteamUser? steamUser = await GetIt.I<SteamUserRepository>().getFirstUser();
  if(steamUser == null) throw NotFoundException("No steam user was found in the system. Aborting...");
  GetIt.I<SettingsRepository>().loadSettings(steamUser.id);
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<Settings>(
      stream: GetIt.I<SettingsRepository>().settings.distinct((Settings previous, Settings next) => previous.darkTheme != next.darkTheme),
